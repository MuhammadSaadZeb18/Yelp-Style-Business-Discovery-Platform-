...
const BussnisesDetail = ({
  ...
  const { fav, openModal, closeModal } = useCollectionModalStore();
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 border-b border-gray-100">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
              ...
              <button
                onClick={openModal}
                className="inline-flex cursor-pointer items-center gap-2 px-4 py-2 bg-pink-50 hover:bg-pink-100 text-pink-600 rounded-lg transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
